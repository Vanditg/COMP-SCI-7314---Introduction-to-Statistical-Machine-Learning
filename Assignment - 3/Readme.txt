...
-- Google Colab repository: The colab repo can be found here - https://colab.research.google.com/drive/1akGgLQ4VqSHSPbP318xmKgQqprmnKs9D?usp=sharing

----------------------------------------------
Jupyter Notebook
----------------------------------------------

- Download the zip file and open the notebook file using 'Jupyter Notebook a3_ISML.ipynb' 
...
- Change the directory to Assignment 3
- Run the notebook using 'Jupyter Notebook a3_ISML.ipynb'
